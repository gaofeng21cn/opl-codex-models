...
The reference source tree is preserved unmodified at
`work/opl-codex-models/` (relative to the workspace root).
No modifications were made to the original repository.